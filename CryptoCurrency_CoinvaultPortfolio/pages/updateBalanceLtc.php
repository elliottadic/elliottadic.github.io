...
updateBalanceLtc.php will prompt the account owner to update their assets information
regarding Litecoin stocks, and upload it to the database, changing the users total assets value.
-->
<html>
    <head>
    ...
    <body>
        ...
        function updateBalance() {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($_POST["LtcBalance"]) && $_POST["LtcBalance"] !== '0') {
                    $errbalance = "Balance cannot be empty";
                }if (isset($_POST["LtcBalance"]) && empty($_POST["Cancel"])) {

                    $balance = $_POST["LtcBalance"];
                    ...
                    if (is_numeric($balance) == true) {
                        ...
                        if ($balance > 84000000) {
                            ...
                            $sql = "UPDATE UserInfo SET LTCBalance='$balance' WHERE userID=$ID";
        ...
        <div class="title">
            ...
            <p id="value">Update Litecoin Balance</p><br>
        </div>


        <div class="container"> 

            <img id="3" src="../images/Litecoin.png" alt="Logo"> <h2>LTC</h2><br>

            <form action="<?php $_SERVER["PHP_SELF"] ?> " method="POST">
                <input type="text" name="LtcBalance" placeholder="New Litecoin Balance"><br>
