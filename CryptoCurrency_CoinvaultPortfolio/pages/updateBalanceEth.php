...
updateBalanceEth.php will prompt the account owner to update their assets information
regarding Ethereum stocks, and upload it to the database, changing the users total assets value.
-->
<html>
    <head>
    ...
    <body>
        ...
        function updateBalance() {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($_POST["EthBalance"]) && $_POST["EthBalance"] !== '0') {
                    $errbalance = "Balance cannot be empty";
                }

                if (isset($_POST["EthBalance"]) && empty($_POST["Cancel"])) {

                    $balance = $_POST["EthBalance"];
                    ...
                    if (is_numeric($balance) == true) {
                        ...
                        if ($balance > 98566051) {
                            ...
                            $sql = "UPDATE UserInfo SET ETHBalance='$balance' WHERE userID=$ID";
        ...
        <div class="title">
            ...
            <p id="value">Update Ethereum Balance</p><br>
        </div>


        <div class="container"> 

            <img id="1" src="../images/Ethereum.png" alt="Logo"> <h2>ETH</h2><br>

            <form action="<?php $_SERVER["PHP_SELF"] ?> " method="POST">
                <input type="text" name="EthBalance" placeholder="New Ethereum Balance"><br>
